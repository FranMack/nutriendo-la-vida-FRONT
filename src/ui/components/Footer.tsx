  ...
  return (
    <footer>
        ...
        <div className="footer-top-left-container">
          ...
          <div className="fotter-info-container">
            ...
            <div className="info-container-item" onClick={linkToWhasap}>
              <WhatsUpIcon />
              <p>+54 9 11 2464-9493</p>
            </div>
          </div>
        </div>
        <div className="fotter-socialMedia-container">
          <div className="socialMedia-container-item" onClick={linkToInta}>
            <InstagramIcon />
          </div>
          <div className="socialMedia-container-item" onClick={linkToLinkedin}>
            <LinkedinIcon />
          </div>
        </div>
      </div>
      <div className="footer-bottom-container">
        ...
        <div onClick={linkToZmDevs} className="zm-container">
