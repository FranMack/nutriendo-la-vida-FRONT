...
export const plans:PlanInfo[]=[
    {title:"Baja de peso sin culpa ni restricciones",price:price.plan,consultPrice:price.consult,
    ...
    {title:"Alimentación y rendimiento deportivo",price:price.plan,consultPrice:price.consult,
        ...
        {title:"Cómo crear buenos hábitos alimenticios",price:price.plan,consultPrice:price.consult,
            ...
            {title:"Alimentación en pre y post menopausia",price:price.plan,consultPrice:price.consult,
