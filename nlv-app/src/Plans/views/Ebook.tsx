...
import { ShopingCartContext, ShopingCartItemOptions } from "../../context/shopingCart.context";
...
export const Ebook = () => {
  ...
  const addToShopingCart=()=>{
    ...
    if(shopingCart.find((item)=>{return item.id===5})){
...
equilibrada, comer sano la mayor parte de tus días.<br/> Aprenderás a planificar tus
comidas semanales y realizando las compras inteligentemente para cocinar 1 día y
