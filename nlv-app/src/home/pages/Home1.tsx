...
export const Home1 = () => {
  ...
  return (
    <section id="home" className='home-section1-container'>
        ...
        <div className='home-section1-center-container'>
            <h1>Decile adiós a las dietas, comé sin culpas y sentite renovada.</h1>
            <h2>Aprenderás a comer sin restricciones, adaptando tu alimentación a tus objetivos y estilo de vida.<br/><br/> 
            De manera real, no perfecta. </h2>
